...
<body class="flex min-h-screen bg-[#F3F6FA] text-gray-800">
  ...
  <div class="flex-1 flex flex-col">
    <header class="bg-white shadow p-4 flex justify-between items-center border-b border-[#E0E3E7]">
      <h1 class="text-2xl font-semibold text-[#2F5395]">Edit Patient</h1>
        ...
        <div class="bg-white shadow rounded-xl p-6">
          <form method="POST" class="space-y-4">
            ...
            <div>
              ...
              <input name="emergency_contact_phone" value="<?= htmlspecialchars($patient['emergency_contact_phone']) ?>" class="w-full border rounded-lg p-2">
            </div>
